...
class GradesReportScreen extends StatelessWidget {
  ...
  const GradesReportScreen({super.key, required this.userDetailsData, required this.report});
                    ...
                    Column(
                      children: [
                        Container(
                          ...
                          child: userDetailsData?.clas != null ? Image.network(userDetailsData!.avatar!) : const Icon(CupertinoIcons.person),
                        ),
                        Row(
                          children: [
